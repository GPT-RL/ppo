...
# ╔═╡ 1ed923c0-f5f0-11eb-3bef-f7866f2a40b0
begin
	using InteractiveUtils
	using PlutoUI
...
# ╔═╡ 63c54d1e-af97-4d59-a7b3-79e688893c42
...
function to_gif(images::Array{Vector{Vector{Float64}}, 1}, scale::Int = 3)
	anim = @Plots.animate for img in images 
		Plots.heatmap(
			...
			showaxis=false,
			aspect_ratio=:equal,
			size=(84 * scale, 84 * scale),
			# title="Observation"
		)
	end
	Plots.gif(anim, fps=length(images))
end

# ╔═╡ ec5e66ce-8244-4720-9cfb-13bdd1ade7bf
ppo_scores = Dict(
	"BreakoutNoFrameskip-v4" => 274.8,
	"BeamRider-v0" => 1590.0,
	"Seaquest-v0" => 1204.5,
	"Qbert-v0" => 14293.3,
